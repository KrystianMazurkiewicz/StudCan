<?php
  ...
  if (isset($_GET['s-id']) && isset($_GET['i-id']) && $_SESSION['role'] == 'organization') {
    ...
    $isSuccess = $crud->set_student_status_to_denied_for_internship($student_id, $internship_id);
  }
  ...
  if (isset($_SESSION['user_id']) && isset($_GET['i-id']) && $_SESSION['role'] == 'student') {
    ...
    $internship_id = $_GET['i-id'];
    $isSuccess = $crud->remove_student_from_internship($student_id, $internship_id);
  }
